...
LGa:AddButton({
    Title = "Rain Fruit",
    Callback = function()
        local fruitObjects = game:GetObjects("rbxassetid://124374213543717")[1]:GetChildren()
        local maxFruits = 10
        local count = 0
...
Main:AddButton({
    ...
    Callback = function()
        pcall(function()
            setclipboard("https://discord.gg/968hN2Yn")
        end)
    end
})
Main:AddParagraph({
    ...
    while task.wait(0.1) do
        pcall(function()
            if getgenv().AutoObservationHakiV2 and World3 then
                ...
                if game.Players.LocalPlayer.Backpack:FindFirstChild("NeXus") and 
                    ...
                    if v.Name == "Cursed Skeleton Boss" and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                        ...
                        elseif not hasNotified then
                            game.StarterGui:SetCore("SendNotification", {
                                ...
                                con = "rbxassetid://118600721466641",
                                Duration = 10,
                            })
                            hasNotified = true
                        end
